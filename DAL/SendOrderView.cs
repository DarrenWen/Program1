...
namespace Express.DAL
{
    ...
    public partial class SendOrderView
    {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM SendOrderView ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM SendOrderView ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int pageSize, int pageCount)
        {
            ...
            string sql = string.Format("select top {0} * from (select top {1} * from SendOrderView {2} order by id desc) order by id", pageSize, pageSize * pageCount, string.IsNullOrEmpty(strWhere) ? "" : " where " + strWhere);
        ...
        public DataSet GetListByPage(string condition,string strWhere, string orderby, int pageSize, int pageCount)
        {
            ...
            string sql = string.Format("select top {0} {3} from (select top {1} {3} from SendOrderView {2} order by id desc) order by id", pageSize, pageSize * pageCount, string.IsNullOrEmpty(strWhere) ? "" : " where " + strWhere,condition);
