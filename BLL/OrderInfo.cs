...
namespace Express.BLL
{
	...
	{
		private readonly Express.DAL.OrderInfo dal=new Express.DAL.OrderInfo();
		public OrderInfo()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<Express.Model.OrderInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Express.Model.OrderInfo> DataTableToList(DataTable dt)
		{
			List<Express.Model.OrderInfo> modelList = new List<Express.Model.OrderInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Express.Model.OrderInfo model;
